...
class LoadDataSecond(Dataset):

    def __init__(self, dataset_dir, test=False):

        if test:
            self.raw_dir = os.path.join(dataset_dir, 'test_input')
            self.dslr_dir = os.path.join(dataset_dir, 'test_canon')
        else:
            self.raw_dir = os.path.join(dataset_dir, 'train_input')
            self.dslr_dir = os.path.join(dataset_dir, 'train_canon')
